    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#button-import").upload({
                action: '${pageContext.request.contextPath}/regionAction_importXls.action',//form表单提交的路径
                name: 'myFile',//上传的输入框的name名称
                onComplete: function (data, self, element) {
                    if(data=="1"){
                        $.messager.alert("提示信息","批量导入成功!","info");
                    }else {
                        $.messager.alert("提示信息","批量导入失败!","warning");
                    }
                }
            });
